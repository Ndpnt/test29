# Declarations of terms tracked in the *test29* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test29-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test29-versions/releases) in the `Ndpnt/test29-versions` repository.
